  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        className='bg-tertiary px-4 py-5 sm:px-5 sm:py-5 rounded-2xl sm:w-[360px] w-full'
      >
        <div className='relative w-full h-[200px] sm:h-[230px]'>
          ...
          <div className='absolute inset-0 flex justify-end m-2 sm:m-3 card-img_hover'>
            <div
              ...
              className='black-gradient w-10 h-10 sm:w-10 sm:h-10 rounded-full flex justify-center items-center cursor-pointer'
            >
              <img
                src={github}
                alt='source code'
